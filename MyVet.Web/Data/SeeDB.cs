...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Danilo", "Lima", "limainformatica@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Admin");
            var customer = await CheckUserAsync("2020", "Luis", "lopez", "tlimar@miumg.edu.gt", "350 634 2747", "Calle Luna Calle Sol", "Customer");
